...
gulp.task('stylus', function () {
  return gulp.src(['src/stylus/*.stylus', 'src/less/*.less'])
...
gulp.task('dabao', ['stylus'], function () {
  return gulp.src(['src/**', '!src/stylus', '!src/stylus/**', '!src/less', '!src/less/**', '!src/images', '!src/images/**', '!src/js', '!src/js/**'])
  // Minifies only if it's a CSS file
    .pipe(gulpIf('*.css', minifyCSS()))
    //Uglifies only if it's a Javascript file
...
gulp.task('default', [ 'myServer','stylus', 'dabao', 'htmlmin', 'babel', 'images'])